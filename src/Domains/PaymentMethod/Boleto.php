...
class Boleto implements Serializer
{
    ...
    /**
     * Prazo para baixa automática do boleto. O cancelamento automático do boleto acontecerá após o número de dias
     * estabelecido neste campo contado a partir da data do vencimento.
     *
     * Ex.: um boleto com vencimento para 15/12 que tenha em seu registro o prazo para baixa de 5 dias, poderá ser
     * pago até 20/12, após esta data o título é cancelado.
     *
     * @param int $value
     *
     * @return self
